...
const client = contentful.createClient({
    space: 'ar0q7djgpaqt', // Insert Contentful Space ID
    accessToken: 'h2FcVoZWrxfEduG30IxNXNfoR_cfM2GAalGTaifqQ7k' // Insert Contentful Content Delivery API access token
});
